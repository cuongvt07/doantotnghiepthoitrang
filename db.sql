...
-- Dumping database structure for graduation_project
...
-- Dumping structure for table graduation_project.addresses
...
-- Dumping data for table graduation_project.addresses: ~6 rows (approximately)
...
-- Dumping structure for table graduation_project.brands
...
-- Dumping data for table graduation_project.brands: ~5 rows (approximately)
...
-- Dumping structure for table graduation_project.categories
...
-- Dumping data for table graduation_project.categories: ~14 rows (approximately)
...
-- Dumping structure for table graduation_project.colors
...
-- Dumping data for table graduation_project.colors: ~8 rows (approximately)
...
-- Dumping structure for table graduation_project.migrations
...
-- Dumping data for table graduation_project.migrations: ~33 rows (approximately)
...
-- Dumping structure for table graduation_project.orders
...
) ENGINE=InnoDB AUTO_INCREMENT=1695648220867 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table graduation_project.orders: ~11 rows (approximately)
...
-- Dumping structure for table graduation_project.order_details
CREATE TABLE IF NOT EXISTS `order_details` (
  ...
  KEY `order_details_product_size_id_foreign` (`product_size_id`),
  CONSTRAINT `order_details_order_id_foreign` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`),
  CONSTRAINT `order_details_product_size_id_foreign` FOREIGN KEY (`product_size_id`) REFERENCES `products_size` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=33 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table graduation_project.order_details: ~27 rows (approximately)
...
-- Dumping structure for table graduation_project.payments
...
-- Dumping data for table graduation_project.payments: ~3 rows (approximately)
...
-- Dumping structure for table graduation_project.products
...
-- Dumping data for table graduation_project.products: ~0 rows (approximately)
...
-- Dumping structure for table graduation_project.products_color
CREATE TABLE IF NOT EXISTS `products_color` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `products_color_color_id_foreign` (`color_id`),
  KEY `products_color_product_id_foreign` (`product_id`),
  CONSTRAINT `products_color_color_id_foreign` FOREIGN KEY (`color_id`) REFERENCES `colors` (`id`),
  CONSTRAINT `products_color_product_id_foreign` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=128 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table graduation_project.products_color: ~0 rows (approximately)
...
-- Dumping structure for table graduation_project.products_size
CREATE TABLE IF NOT EXISTS `products_size` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `products_size_product_color_id_foreign` (`product_color_id`),
  KEY `products_size_size_id_foreign` (`size_id`),
  CONSTRAINT `products_size_product_color_id_foreign` FOREIGN KEY (`product_color_id`) REFERENCES `products_color` (`id`),
  CONSTRAINT `products_size_size_id_foreign` FOREIGN KEY (`size_id`) REFERENCES `sizes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=417 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Dumping data for table graduation_project.products_size: ~0 rows (approximately)
...
-- Dumping structure for table graduation_project.product_reviews
...
-- Dumping data for table graduation_project.product_reviews: ~0 rows (approximately)
...
-- Dumping structure for table graduation_project.roles
...
-- Dumping data for table graduation_project.roles: ~3 rows (approximately)
INSERT INTO `roles` (`id`, `name`) VALUES
	(1, 'Quản trị viên'),
	(2, 'Nhân Viên'),
	(3, 'Khách hàng');

-- Dumping structure for table graduation_project.setting
...
-- Dumping data for table graduation_project.setting: ~0 rows (approximately)
...
-- Dumping structure for table graduation_project.sizes
...
-- Dumping data for table graduation_project.sizes: ~4 rows (approximately)
...
-- Dumping structure for table graduation_project.users
...
-- Dumping data for table graduation_project.users: ~0 rows (approximately)
INSERT INTO `users` (`id`, `name`, `email`, `password`, `email_verified_at`, `phone_number`, `role_id`, `active`, `disable_reason`, `created_by`, `updated_by`, `deleted_by`, `remember_token`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'Admin', 'admin@gmail.com', '$2a$12$VxqsJdoYt7X2L.EfaL5yGOcBm4RYq4Q/uyvNrZjuZA4rXdb35hUwy', '2023-04-28 04:29:18', '0000000000', 1, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(2, 'Ho Anh Nguyen', 'test@gmail.com', '$2a$12$VxqsJdoYt7X2L.EfaL5yGOcBm4RYq4Q/uyvNrZjuZA4rXdb35hUwy', '2023-05-02 03:25:18', '1234567890', 3, 1, NULL, NULL, NULL, NULL, NULL, '2023-05-02 03:24:23', '2023-05-02 03:25:18', NULL),
...
-- Dumping structure for table graduation_project.user_verifies
...
-- Dumping data for table graduation_project.user_verifies: ~4 rows (approximately)
...
-- Dumping structure for trigger graduation_project.group_by_quantity
...
-- Dumping structure for trigger graduation_project.reduce_quantity_product
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
...
-- Dumping structure for trigger graduation_project.validate_quantity
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_AUTO_VALUE_ON_ZERO';
DELIMITER //
